...
ensure_env_file "$DISTRIBUTED_KEY_GENERATOR_EXECUTE_ENV_PATH" "./scripts/execute/env_example.sh"
...
ensure_env_file "$DISTRIBUTED_KEY_GENERATOR_RPC_CALL_ENV_PATH" "./scripts/rpc-call/env_example.sh"
